/*  4B-VMT Utiliza y programa tarjetas electrónicas de control
    ...
    Proyecto 1
    Equipo:
      Padilla Avila Saul Emiliano
      Sanchez Zarate Andre Karim
      Tadeo Arellano Aldrick Victor
      Valencia Lopez Danna Rosaura
    Github Repository location: https://github.com/aldrick-t/pong-with-arduino.git
*/
